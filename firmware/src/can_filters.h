...
{
    // Group 0
    MCP2515_FILTER(CAN_MSG_MIC19_MOTOR_ID), // Filter 0
    MCP2515_FILTER(CAN_MSG_MIC19_PUMPS_ID), // Filter 1

    // Group 1
    MCP2515_FILTER(CAN_MSG_MIC19_MOTOR_ID), // Filter 0
    MCP2515_FILTER(CAN_MSG_MIC19_PUMPS_ID), // Filter 0
    MCP2515_FILTER(CAN_MSG_MIC19_STATE_ID), // Filter 1
    MCP2515_FILTER(0b00000001100), // Filter 1
